...
type ResizableHandleProps = React.ComponentPropsWithoutRef<typeof ResizableHandlePrimitive> & {
  withHandle?: boolean
}
...
const ResizableHandle = ({ className, withHandle, ...props }: ResizableHandleProps) => (
  <ResizableHandlePrimitive
    className={cn(
      ...
      "data-[resize-handle-state=hover]:bg-border-hover data-[resize-handle-state=drag]:bg-border-hover",
      className
    )}
    {...props}
  >
